...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Profile', fields ['vk_id']
        db.create_index('vk_iframe_profile', ['vk_id'])


    def backwards(self, orm):
        # Removing index on 'Profile', fields ['vk_id']
        db.delete_index('vk_iframe_profile', ['vk_id'])
    ...
    models = {
        ...
        'vk_iframe.profile': {
            ...
            'vk_id': ('django.db.models.fields.IntegerField', [], {'default': '0', 'db_index': 'True'})
        }
    }
